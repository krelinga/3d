...
openscad -o $OUT_BASE/stl/bases/40mm_heavy.stl scad/bases/40mm_heavy.scad
...
openscad -o $OUT_BASE/stl/bases/two_inch_heavy.stl scad/bases/two_inch_heavy.scad
