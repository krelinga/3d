...
| `fred-drawer-dovetail-coupon` | 1.1.0 | Dovetail fit coupon for the drawer organizer - one tab and five sockets stepped either side of nominal, to find the clearance your printer actually produces | [fred-drawer-dovetail-coupon/v1.1.0](https://github.com/krelinga/3d/releases/tag/fred-drawer-dovetail-coupon%2Fv1.1.0) | ![fred-drawer-dovetail-coupon](thumbnails/fred-drawer-dovetail-coupon/fred-drawer-dovetail-coupon.png) |
